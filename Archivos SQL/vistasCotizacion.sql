...
AS
SELECT        C.nombre, C.telefono, C.telefono2, C.correo, Con.atencionDe, M.numeroMuestras, Co.id, Co.anno, Co.precioMuestreo, Co.precioMuestra, Co.descuento, Co.gastosAdm, Co.saldoAfavor, Co.diasEntregaRes, Co.granTotal, 
...
FROM            dbo.ClienteCotizacion AS C INNER JOIN
                         ...
                         dbo.tipoAnalisis AS T ON T.tipo = A.tipoAnalisis INNER JOIN
                         dbo.Muestra AS M ON M.tipoAnalisis = T.tipo
